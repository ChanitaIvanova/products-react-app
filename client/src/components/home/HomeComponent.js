...
export const HomeComponent = ({ fetchProducts, areLoading, products }) => {
    const [isLoading, setIsLoading] = useState(true);
    const [hasReadPermissions, setHasReadPermissions] = useState(false);
    ...
    const getPermissionsAndProducts = () => {
    ...
    useEffect(getPermissionsAndProducts, []);
...
//                     this.state.hasDeletePermissions) && (
//                     <td>
//                         {this.state.hasEditPermissions && (
//                             <button
//                                 className='primary-btn'
//                                 onClick={() => this.openEdit(product)}
//                             >
//                                 Edit
//                             </button>
//                         )}
...
//                             <button
//                                 className='danger-btn'
//                                 onClick={() => this.openDelete(product)}
//                             >
//                                 Delete
//                             </button>
//                         )}
